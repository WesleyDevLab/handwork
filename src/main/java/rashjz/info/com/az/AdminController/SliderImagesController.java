...
public class SliderImagesController implements Serializable{
  ...
  private static final Logger logger = LoggerFactory.getLogger(SliderImagesController.class.getName());   
  ...
  @RequestMapping(value = "/slideradmin/uploadsliderimagemulti", method = RequestMethod.POST)
