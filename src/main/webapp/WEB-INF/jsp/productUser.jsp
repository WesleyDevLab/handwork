    ...
    <body>
        ...
        <jsp:include page="fragment/menu.jsp" />
                ...
                <div class=" panel col-md-12 ">  
                    <div class="panel  panel-table " style="margin: auto">  
                        <div class="panel-heading">
                            <div class="row">
                                
                                <form:form id="headerSearchForm" action="productsuser" modelAttribute="productsuser" class="col-sm-3 col-md-3 col-lg-12"  method="GET">
